...
import type { BindingsStream, FragmentSelectorShape, IActionContext, IDiscoverEventData, IQueryBindingsOptions, IQuerySource, QuerySourceReference } from '@comunica/types';
import type { Quad } from '@rdfjs/types';
import type { AsyncIterator } from 'asynciterator';
import type { Operation, Ask, Update } from 'sparqlalgebrajs/lib/algebra';
import { AggregateStatisticTraversedTopology, ITopologyEventNotification } from '../lib/AggregateStatisticTraversedTopology';
  ...
  describe('An AggregateStatisticTraversedTopology instance should', () => {
    ...
    beforeEach(() => {
      ...
      aggregateStatisticTraversedTopology = new AggregateStatisticTraversedTopology(
          statisticLinkDiscovery, statisticLinkDereference, mockLogFunction);
