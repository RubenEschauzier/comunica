...
A comunica Statistic Link Discovery Context Preprocess Actor. This actor tracks discovered links and their metadata. If a link is discovered multiple times this actor saves the metadata in a list of JSON objects.
