...
const HINT_SUBJECT = 'https://comunica.dev/hint';
const HINT_PREDICATE = 'https://comunica.dev/optimizer';
const HINT_OBJECT = 'None';
 ...
 * in the query algebra. If found, it removes the hint triple from the algebra
