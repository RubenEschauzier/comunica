...
export interface IActorInitQueryBaseArgs<QueryContext extends IQueryContextCommon = IQueryContextCommon>
   ...
   *   "modelInstanceLSTM": "@comunica/actor-rdf-join-inner-multi-reinforcement-learning:ModelInstanceLSTM",
   *   "modelInstanceGCN": "@comunica/actor-rdf-join-inner-multi-reinforcement-learning:ModelInstanceGCN",
